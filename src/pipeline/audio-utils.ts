 ...
 */
export function base64MulawToLinear16(base64Audio: string): Buffer {
 ...
 */
export function linear16ToBase64Mulaw(linear16Buffer: Buffer): string {
 ...
 */
export function audioToTwilioPayload(audioBuffer: Buffer, inputFormat: 'linear16' | 'mulaw'): string {
