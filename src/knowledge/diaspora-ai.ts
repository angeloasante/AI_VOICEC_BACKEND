 ...
 */
export const diasporaAIBusiness: BusinessKnowledge = {
  name: "Diaspora AI",
...
export async function checkVisaRequirements(
  ...
  const apiKey = config.diasporaAI?.visaApiKey;
 ...
 */
export function formatVisaResponse(visaData: any): string {
  if (!visaData) {
